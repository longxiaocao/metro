...
class m_IDirect3DViewport2 : public dx6::IDirect3DViewport2, public AddressLookupTableObject
{
private:
	dx6::IDirect3DViewport2 *ProxyInterface;

public:
	m_IDirect3DViewport2(dx6::IDirect3DViewport2 *aOriginal,void *temp) : ProxyInterface(aOriginal)
	{
	...
	dx6::IDirect3DViewport2 *GetProxyInterface() { return ProxyInterface; }
