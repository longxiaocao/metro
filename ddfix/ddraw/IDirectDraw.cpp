...
const dx6::D3DDEVICEDESC7 d3ddesc_default =
{
...
{ //dpcLineCaps
	...
	8, //dwMaxActiveLights
	0.0f, //dvMaxVertexW 
	dx6::IID_IDirect3DHALDevice, //deviceGUID
...
{ //dtcTransformCaps
	sizeof(dx6::D3DTRANSFORMCAPS), //dwSize
	0 // dwCaps
},
FALSE, //bClipping
{ // dlcLightingCaps
	sizeof(dx6::D3DLIGHTINGCAPS), //dwSize
