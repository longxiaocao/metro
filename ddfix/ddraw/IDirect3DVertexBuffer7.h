...
class m_IDirect3DVertexBuffer7 : public dx6::IDirect3DVertexBuffer7, public AddressLookupTableObject
{
private:
	dx6::IDirect3DVertexBuffer7 *ProxyInterface;
...
public:
	...
	m_IDirect3DVertexBuffer7(dx6::IDirect3DVertexBuffer7 *aOriginal, void *temp)
	...
	dx6::IDirect3DVertexBuffer7 *GetProxyInterface() { return ProxyInterface; }
	...
	/*** dx6::IDirect3DVertexBuffer7 methods ***/
	STDMETHOD(Lock)(THIS_ DWORD, LPVOID*, LPDWORD);
	STDMETHOD(Unlock)(THIS);
	STDMETHOD(ProcessVertices)(THIS_ DWORD, DWORD, DWORD, dx6::LPDIRECT3DVERTEXBUFFER7, DWORD, dx6::LPDIRECT3DDEVICE7, DWORD);
	STDMETHOD(GetVertexBufferDesc)(THIS_ dx6::LPD3DVERTEXBUFFERDESC);
	STDMETHOD(Optimize)(THIS_ dx6::LPDIRECT3DDEVICE7, DWORD);
	STDMETHOD(ProcessVerticesStrided)(THIS_ DWORD, DWORD, DWORD, dx6::LPD3DDRAWPRIMITIVESTRIDEDDATA, DWORD, dx6::LPDIRECT3DDEVICE7, DWORD);
};
