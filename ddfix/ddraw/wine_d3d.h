...
#include <objbase.h>
// Phase 8.25: 由项目内的 wine_d3dtypes.h / wine_d3dcaps.h 替代 Windows SDK 的 d3dtypes.h / d3dcaps.h。
// 原因: Windows SDK 的 d3dtypes.h 与 d3d9types.h 有相同的 enum 类型 (D3DBLEND, D3DFILLMODE 等),
// 在同一 TU 内无法共存。Wine 的 d3dtypes.h 没有 enum 类型 (只 typedef struct),可以安全地
// 包裹到 namespace dx6 与 d3d9types.h (全局) 共存。
// Wine 的 d3d.h 同时定义 DX5/DX6/DX7 接口 (Windows SDK 的 d3d.h 只在一种 DIRECT3D_VERSION 下定义),
// 解决 IDirect3D (DX5) 与 IDirect3D7 (DX7) 接口不能同时定义的问题。
#include "wine_d3dtypes.h" /* must precede wine_d3dcaps.h */
...
/* ********************************************************************
   Enums
   ******************************************************************** */
#define D3DNEXT_NEXT ((LONG)(0x01))
#define D3DNEXT_HEAD ((LONG)(0x02))
#define D3DNEXT_TAIL ((LONG)(0x04))

#define D3DDP_WAIT               ((LONG)(0x00000001))
#define D3DDP_OUTOFORDER         ((LONG)(0x00000002))
#define D3DDP_DONOTCLIP          ((LONG)(0x00000004))
#define D3DDP_DONOTUPDATEEXTENTS ((LONG)(0x00000008))
#define D3DDP_DONOTLIGHT         ((LONG)(0x00000010))
